...
// 🔧 CORRECTION: Commenté les @font-face FontAwesome pour éviter les erreurs
// Les icônes FontAwesome seront chargées via le CSS standard
const headStyleInnerHtml = `
    /* FontAwesome sera chargé via le CSS importé */
`
