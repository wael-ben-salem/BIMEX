...
class XKTModel {
    ...
    constructor(cfg = {}) {
         ...
         * 🔧 CORRECTION: Augmenté de 10000 à 200000 pour gérer les géométries complexes
         *
         * @type {Number}
         */
        this.maxIndicesForEdge = cfg.maxIndicesForEdge || 200000;
    }
    ...
    createGeometry(params) {
        ...
        if (triangles) {
            ...
            if (xktGeometryCfg.indices.length < this.maxIndicesForEdge) {
                ...
                console.info("[XKTModel.createGeometry] 🔧 Géométrie complexe détectée - calcul des arêtes désactivé pour optimiser les performances. Indices: "
                    + xktGeometryCfg.indices.length
                    + " (limite: " + this.maxIndicesForEdge + ")"
                    + " GeometryId=" + geometryId);
            }
        }
